...
$c_Lcom_darkoverlordofdata_demo_BrowserLauncher$.prototype.main__V = (function() {
  $g.PIXI.loader.add("images/badlogic.jpg").load((function(loader$2, res$2) {
    var config = new $g.gdx.JsApplicationConfiguration();
    config.width = 320.0;
    config.height = 480.0;
    return new $g.gdx.JsApplication(new $c_Lcom_darkoverlordofdata_demo_Main().init___(), config)
  }))
});
...
/** @constructor */
function $c_Lcom_darkoverlordofdata_demo_Main() {
  $c_O.call(this);
  this.batch$1 = null;
  this.img$1 = null
}
$c_Lcom_darkoverlordofdata_demo_Main.prototype = new $h_O();
$c_Lcom_darkoverlordofdata_demo_Main.prototype.constructor = $c_Lcom_darkoverlordofdata_demo_Main;
/** @constructor */
function $h_Lcom_darkoverlordofdata_demo_Main() {
  /*<skip>*/
}
$h_Lcom_darkoverlordofdata_demo_Main.prototype = $c_Lcom_darkoverlordofdata_demo_Main.prototype;
$c_Lcom_darkoverlordofdata_demo_Main.prototype.init___ = (function() {
  this.batch$1 = null;
  this.img$1 = null;
  return this
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.$$js$exported$meth$dispose__O = (function() {
  return (void 0)
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.$$js$exported$meth$resize__D__D__O = (function(width, height) {
  return (void 0)
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.$$js$exported$meth$create__O = (function() {
  this.create__V()
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.$$js$exported$meth$render__O = (function() {
  this.render__V()
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.render__V = (function() {
  $g.gdx.Gdx.gl.glClearColor(1.0, 0.0, 0.0, 1.0);
  $g.gdx.Gdx.gl.glClear($uD($g.gdx.graphics.GL20.GL_COLOR_BUFFER_BIT));
  this.batch$1.begin();
  this.batch$1.draw(this.img$1, 0.0, 0.0);
  this.batch$1.end()
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.create__V = (function() {
  this.batch$1 = new $g.gdx.graphics.g2d.SpriteBatch();
  this.img$1 = new $g.gdx.graphics.Texture("images/badlogic.jpg")
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.$$js$exported$meth$resume__O = (function() {
  return (void 0)
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.$$js$exported$meth$pause__O = (function() {
  return (void 0)
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.create = (function() {
  return this.$$js$exported$meth$create__O()
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.resize = (function(arg$1, arg$2) {
  var prep0 = $uD(arg$1);
  var prep1 = $uD(arg$2);
  return this.$$js$exported$meth$resize__D__D__O(prep0, prep1)
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.render = (function() {
  return this.$$js$exported$meth$render__O()
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.pause = (function() {
  return this.$$js$exported$meth$pause__O()
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.resume = (function() {
  return this.$$js$exported$meth$resume__O()
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.dispose = (function() {
  return this.$$js$exported$meth$dispose__O()
});
var $d_Lcom_darkoverlordofdata_demo_Main = new $TypeData().initClass({
  Lcom_darkoverlordofdata_demo_Main: 0
}, false, "com.darkoverlordofdata.demo.Main", {
  Lcom_darkoverlordofdata_demo_Main: 1,
  O: 1,
  Lcom_badlogic_gdx_ApplicationAdapter: 1,
  Lcom_badlogic_gdx_ApplicationListener: 1
});
$c_Lcom_darkoverlordofdata_demo_Main.prototype.$classData = $d_Lcom_darkoverlordofdata_demo_Main;
