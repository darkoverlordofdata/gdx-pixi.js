...
/**
 * Entitas Generated Components for com.darkoverlordofdata.demo
 *
...
case class BulletComponent() extends IComponent
case class DestroyComponent() extends IComponent
case class EnemyComponent() extends IComponent
case class ExpiresComponent(delay:Float = 0f) extends IComponent
case class FiringComponent() extends IComponent
...
case class PlayerComponent() extends IComponent
...
object EntityExtensions {
    ...
    // Component Pools
    private var boundsComponentPool = new ListBuffer[BoundsComponent]()
